		...
		echo"
			...
			<div id='extras' class='fixed-bg extras'>
				...
				<div style='width: 80%; background-color: rgba(255,255,255,0.5); margin: auto'>
					...
					<a style='text-align: center' href='food/bayarea.php'>The Bay Area: Incomplete</a><br><br>
					<a style='text-align: center' href='food/socal.php'>Southern California:Incomplete</a><br><br>
					<a style='text-align: center' href='food/stl.php'>St. Louis:Incomplete</a><br><br>
					<h3>Music</h3>
					...
					<br><br><a href='books/main.php'>Book Recommendations: Incomplete</a>
				</div>
			</div>
